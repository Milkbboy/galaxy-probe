...
> 작성: 2026-04-23 · 최종 갱신: 2026-05-05 (Aim/Gem → Constants 통합, 11탭)
> 용도: Google Sheets 11 탭에 붙여넣은 **초기 데이터** 보존본. 시트가 SSoT 가 된 후 참고용.
...
| `Constants.csv`              | `Constants`     | [Data-SheetsGuide.md §11](../../Data-SheetsGuide.md#11-constants-시트) — 게임 전역 const Key/Value row, Aim·Gem 크기 |
