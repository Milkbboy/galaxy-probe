...
> 상위 문서: [CharacterAbilitySystem.md](CharacterAbilitySystem.md) (Unity 이식 설계) / [V2_IntegrationPlan.md](V2_IntegrationPlan.md) (총론)
...
- 설계·인터페이스는 [CharacterAbilitySystem.md](CharacterAbilitySystem.md) 참조
...
Unity 포팅 시 `CharacterAbilitySystem.md §7`의 `SlotUI` 구조 그대로 사용.
...
- [CharacterAbilitySystem.md](CharacterAbilitySystem.md) — Unity 이식 설계 (SO 구조 · IAbilityRunner · 슬롯 UI)
- [V2_IntegrationPlan.md](V2_IntegrationPlan.md) — 총론 · 작업 우선순위 §4 · 좌표계 §5
- [WeaponUnlockUpgradeSystem.md](WeaponUnlockUpgradeSystem.md) — 지뢰가 참조하는 폭탄 강화
