...
상세: `Sys-Weapon.md` (v2 현행), `WeaponSystem.md` (Phase 3 아카이브)
...
## 10. 참고
- 데이터 계층: `Overview-DataStructure.md`
- Bug 행동 시스템: `BugBehaviorSystem.md`
- 시스템별: `WeaponSystem.md` / `FormationSystem.md` / `Sys-Camera.md` / `Sys-Minimap.md`
- 시트/Import: `Data-SheetsGuide.md`
- 전체 기획/로드맵: `Overview-Plan.md`
