...
| 7 | 보석 드랍/채집 (`GemDrop`/`GemPickup`) | ✅ | `Scripts/Pickup/Gem.cs` + `GemDropSpawner.cs`. v2 2종 보석 (일반 #aadfff +1 / 엘리트 #ffd700 +5). 세션 종료 시 일괄 정산. 상세 [GemMiningSystem.md §10](GemMiningSystem.md) |
