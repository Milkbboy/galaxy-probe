...
> 상위 문서: [CharacterAbilitySystem.md](CharacterAbilitySystem.md) §5.7~5.9
> 형제 문서: [Phase5_VictorAbility_Plan.md](Phase5_VictorAbility_Plan.md) / [Phase6_SaraAbility_Plan.md](Phase6_SaraAbility_Plan.md)
> v2 레퍼런스: [CharacterAbility_v2Reference.md](CharacterAbility_v2Reference.md) §3.7~3.9

## 0. 목표

`CharacterAbilitySystem.md` 스펙의 지누스 3종 어빌리티를 Game 씬에 3D 이펙트로 구현. 빅터·사라 페이즈에서 만든 공통 인프라(`AbilityContext`, `IAbilityRunner`, `AbilitySlotController`, `AbilityRangeDecal`, `AbilityDecalMeshBuilder`)는 그대로 재사용.
